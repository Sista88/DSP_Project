...
st.image(image, caption='Home Loan Prediction', width=800)
st.subheader("Worried about your home loan application status and want to know your results right now?")
